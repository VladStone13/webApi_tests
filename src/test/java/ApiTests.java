...
public class ApiTests {
    ...
    public void test1_upload() throws IOException {
        ...
        File file = new File("src/img/mem.jpg");
        JSONObject uploadObj = new JSONObject();
        uploadObj.put("path", "/Apps/Test_WebAPI/mem.jpg");
    ...
    public void test2_getMetaData(){
        ...
        getMetadataObj.put("path", "/Apps/Test_WebAPI/mem.jpg");
    ...
    public void test3_delete(){
        ...
        deleteObj.put("path", "/Apps/Test_WebAPI/mem.jpg");
